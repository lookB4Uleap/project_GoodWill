    ...
    <main class="Confirm-Order">
        ...
        <div class="Order-Section">
            ...
            <form action="/validate_order_from_cart.php" method="post">
                ...
                <input type="number" value="<?php echo $row['item_id'] ?>" id="item_id" name="item_id_<?php echo $i ?>" style="display: none;">
                <input type="number" value="<?php echo $row['item_quant'] ?>" id="item_quant" name="item_quant_<?php echo $i ?>" style="display: none;">
                ...
                <input type="number" value="<?php echo $i ?>" id="item_count" name="item_count" style="display: none;">
